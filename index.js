...
// Инициализация на ethers provider (за четене на баланси)
...
async function executeTrade() {
    ...
    if (maticBalance < 0.01) {
        ...
        await sendToTelegram(`⛔ Ботът спря: няма MATIC за газ! Имате ${maticBalance.toFixed(4)} MATIC. Моля, депозирайте поне 0.5 MATIC.`);
        isBotActive = false;

...
// Временна заглушка за баланса – ще работи след депозит
async function getUSDCBalance(address) {
    // Тук може да добавиш реално четене на USDC (Polygon) чрез ethers или viem
    // За момента връща 0, но след депозит ще се види
    return 0;
}

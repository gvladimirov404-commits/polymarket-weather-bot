...
// Публичен RPC (Blastapi.io) – не изисква API ключ
const RPC_URL = 'https://polygon-mainnet.public.blastapi.io';

// USDC contract on Polygon (native)
...
(async () => {
    try {
        ...
        signer = createWalletClient({ account, transport: http(RPC_URL), chain: polygon });

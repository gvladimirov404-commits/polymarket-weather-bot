...
let settings = JSON.parse(JSON.stringify(DEFAULT_SETTINGS)); // копиране
...
function loadSettings() {
    try {
        if (fs.existsSync(SETTINGS_FILE)) {
            ...
            if (saved.settings) {
                // сливаме със запазените настройки
...
async function saveSettings() {
    ...
    if(result.success) { alert('✅ Настройките са запазени!'); location.reload(); }
...
app.post('/settings', (req, res) => {
    console.log('📝 Запазване на настройк

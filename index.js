...
// Глобални променливи за динамично управление на капитала
let currentBalance = 70.00;
let currentBetSize = 5.00; 
...
// Връща текущите стойности към интерфейса
...
app.get('/', (req, res) => {
    ...
    <body>
        ...
        <script>
            ...
            // Преводи за абсолютно всички компоненти, включително новите настройки
            const translations = {
                bg: { 
                    bal: "ТЕКУЩ БАЛАНС (USDC)", 
                    setBal: "ПРОМЕНИ ДЕПОЗИТ", 
                    setBet: "СТАВКА (ЗАЛОГ)", 
                    ref: "РЕФЕРАЛ ЗА ОТСТЪПКА", 
                    sub: "Покани 4 приятели за цена 1 USDT/мес", 
                    btn: "ИЗПЪЛНИ СДЕЛКА СЕГА", 
                    logMode: "Режим: ", 
                    logSaved: "Настройките запазени: Ставка $",
                    logSending: "Изпращане на ордер...",
                    logSuccess: "УСПЕХ: Сигналът е подаден."
                },
                ru: { 
                    bal: "ТЕКУЩИЙ БАЛАНС (USDC)", 
                    setBal: "ИЗМЕНИТЬ ДЕПОЗИТ", 
                    setBet: "СТАВКА (ОБЪЕМ)", 
                    ref: "РЕФЕРАЛ ДЛЯ СКИДКИ", 
                    sub: "Пригласи 4 друзей за цену 1 USDT/мес", 
                    btn: "ВЫПОЛНИТЬ СДЕЛКУ СЕЙЧАС", 
                    logMode: "Режим: ", 
                    logSaved: "Настройки сохранены: Ставка $",
                    logSending: "Отправка ордера...",
                    logSuccess: "УСПЕШНО: Сигнал отправлен."
                },
                en: { 
                    bal: "CURRENT BALANCE (USDC)", 
                    setBal: "EDIT DEPOSIT", 
                    setBet: "BET SIZE (VOLUME)", 
                    ref: "REFERRAL DISCOUNT", 
                    sub: "Invite 4 friends for 1 USDT/month", 
                    btn: "EXECUTE TRADE NOW", 
                    logMode: "Mode: ", 
                    logSaved: "Settings saved: Bet size $",
                    logSending: "Sending order...",
                    logSuccess: "SUCCESS: Signal deployed."
                }
            };
